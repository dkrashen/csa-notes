...
\[E \otimes E = E[t]/\prod (t - \alpha_i) = \times E[t]/(t - \alpha_i)
\cong \times^n E e_i,\]
...
\[E \otimes E = \times_{\sigma \in G} E[t]/(t - \sigma(\alpha)) \cong
\times_{\sigma \in G} E e_\sigma.\]
...
that $\pi_\sigma(x \otimes y) = x \sigma(y)$ for $x, y, \in E$.
